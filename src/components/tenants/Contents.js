...
export const Pricing = () => {
  ...
  return (
    <div className="tenants-pricing">
      <div className="left-price-tenants">
        <h2 className="price-title">{t("Pricing.title")}</h2>
        <div className="pay-box">
          <h2 className="succeed">{t("Pay if you succeed.title")}</h2>
        </div>
        <div className="tenants-long-text-box-price">
          <p className="text-price">{t("We are providing full.title")}</p>
          <p className="text-price">{t("transparency of user.title")}</p>
          <p className="text-price">{t("profiles and listed.title")}</p>
          <p className="text-price">{t("rooms/apartments so that.title")}</p>
      ...
      <div className="right-price-tenants"></div>
    </div>
  );
};
